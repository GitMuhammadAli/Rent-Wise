...
function SignIn() {
  ...
  return (
    <section className=" flex md:flex-row mx-auto px-3 w-[100%] h-1/3 ">
      <div className=" md:pt-[67px] pb-8 md:pb-[87px] flex flex-col-reverse md:flex-row container mx-auto px-4 md:px-6">
        <div className=" md:mb-0 md:ml-[10px] md:mr-5 md:mt-[10px] w-full md:w-1/2 flex flex-col items-center">
          <img src="/images/signin-image.jpg" alt="sign in" />
          <p className="mt-6 text-center">
            <Link to="/auth/signup" className="text-black-500 hover:underline">
              Create an account
            </Link>
          </p>
        </div>
        <div className="w-full md:w-5/12 p-4 md:p-8">
          ...
          <form onSubmit={handleSubmit} method="POST" className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className=" w-full py-2 text-white bg-black rounded-lg hover:bg-white hover:text-black hover:border border-black  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                Log in
              </button>
            </div>
