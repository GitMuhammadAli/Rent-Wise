...
import { Search, Filter, Eye, Trash2, Calendar, DollarSign, User, Tag, MapPin, X } from "lucide-react"
...
const listings = [
  {
    ...
    image: "/placeholder.svg?height=80&width=120&text=Apartment",
    location: "Downtown, New York",
    description: "A beautiful apartment in the heart of downtown with all amenities included.",
    views: 245,
    inquiries: 12,
  },
  {
    ...
    image: "/placeholder.svg?height=80&width=120&text=Car",
    location: "Los Angeles, CA",
    description: "A comfortable sedan perfect for city driving and short trips.",
    views: 189,
    inquiries: 8,
  },
  {
    ...
    image: "/placeholder.svg?height=80&width=120&text=Hostel",
    location: "University District, Chicago",
    description: "Affordable hostel room for students near the university campus.",
    views: 120,
    inquiries: 5,
  },
  {
    ...
    image: "/placeholder.svg?height=80&width=120&text=Beach+House",
    location: "Miami Beach, FL",
    description: "Beautiful beach house with ocean views and private access to the beach.",
    views: 310,
    inquiries: 18,
  },
  {
    ...
    image: "/placeholder.svg?height=80&width=120&text=SUV",
    location: "Seattle, WA",
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                <div className="bg-gray-100 rounded-lg px-4 py-2 flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{selectedListing.owner}</p>
                  </div>
                </div>
                <div className="bg-gray-100 rounded-lg px-4 py-2 flex items-center">
