    ...
    const saveAgreement = async()=>{
      ...
      return (
        <Box minH="100vh" display="flex" alignItems="center" justifyContent="center" p={4}>
          <Card w="full" maxW="4xl" bg="white" shadow="lg" position="relative" overflow="hidden">
            <Box
              position="absolute"
              inset="0"
            ...
            <Box position="relative" zIndex={10} p={[8, 12]}>
              ...
              <Box mb={4}>
                <Text color={'red'} fontWeight={'semibold'}>
                  Note: This agreement will be stored in blockchain and can't be updated or tempered later after the confirmation from both sides.
                </Text>
              </Box>
              ...
              <VStack spacing={4} align="stretch" mb={8}>
                ...
                {
                    user && (
                        <Text  h={'fit-content'} borderBottom={'1px solid'}>{user.name}</Text>
                    )
                }
    ...
    { listingDetail && listingDetail.length> 0 && listingDetail.map((list,i)=>(
      <MenuItem key={list._id || i} onClick={()=> listingFucntion(list._id)}>{list.title}</MenuItem>
              ...
              <VStack align="stretch" spacing={4} mb={8}>
                ...
                <Box as="ol" listStyleType="decimal" pl={4} spacing={2} color="gray.700">
                  <Text as="li">
                  ...
                  <Text as="li">
                    ...
                    <Input
                      ...
                      fontWeight="semibold"
                    />
                    is required, refundable at the end of the lease term, subject to the condition of the property.
                  </Text>
                  <Text as="li">
                    The tenant agrees to use the property for residential purposes only and to maintain it in good condition.
                  </Text>
                </Box>
              </VStack>
