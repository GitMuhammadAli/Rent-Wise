  ...
  return (
    ...
    <div>
      ...
      >
          ...
          <Box position="relative" zIndex={10} p={[8, 12]}>
            <Box textAlign="center" mb={8}>
              <Flex alignItems={"center"} gap={4}>
                <Text>
                  The listing for which this agreement is being made is{" "}
                  {listingDetail?.title || "No listing Found"}
                </Text>
            ...
            <Box mb={4}>
              <Text color={"red"} fontWeight={"semibold"}>
                ...
                updated or tempered later after the confirmation from both
                sides.
              </Text>
            </Box>
              ...
              >
                ...
                <Text as="li">
                  ...
                  <Input
                    ...
                    fontWeight="semibold"
                  />
                  is required, refundable at the end of the lease term, subject
                  ...
                  <Flex alignItems={"center"} gap={4}>
                    {ownerConfirmed ? (
                      ...
                      <>
                        ...
                        />{" "}
                        <Text color={"red"}>
                          Not yet Confirmed By {ownerDetail.name}
                        </Text>{" "}
                      </>
                    )}
                  </Flex>
                  ...
                  <Flex>
                    {renterConfirmed ? (
                      <>
                        ...
                        <Text color={"green.500"}>
                          {" "}
                          Confirmed By {renterDetails.name}
                        </Text>
                      </>
                    ) : (
                      <>
                        ...
                        />{" "}
                        <Text color={"red"}>
                          Not yet Confirmed By {renterDetails.name}
                        </Text>{" "}
                      </>
                    )}
                  </Flex>
        ...
        {user && user._id === ownerDetail._id ? (
          <Button
            onClick={OwnerConfirmed}
            bg={ownerConfirmed ? "green" : "black"}
            color={"white"}
          >
            {" "}
          ...
          <Button
            onClick={RenterConfirmed}
            bg={renterConfirmed ? "green" : "black"}
            color={"white"}
          >
            {" "}
